...
window.SS_REGIONS = {
  ...
  toronto: {
    ...
    // Pre-launch: Toronto shows everywhere but as "Coming Soon" (not orderable).
    // Flip this to false in Backend → Menu & Regions when you're ready to launch.
    comingSoon: true,

    announcement: {
      enabled: true,
      text: "Toronto is launching soon — join the list to get the drop first. 🇨🇦",
      style: "coming-soon",
    },
