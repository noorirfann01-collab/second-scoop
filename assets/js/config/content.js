...
window.SS_CONTENT = {
  ...
  theme: {
    choc:    "#2b1600",   // Cocoa — main brand / text
    caramel: "#8b152c",   // Cherry Red — accent (links, headings, CTAs)
    cookie:  "#ce9155",   // Salted Caramel — warm cookie tone
    cream:   "#ffeec4",   // Very Vanilla — page background
    blush:   "#f8b6b8",   // Sugar Rush — soft pink accent
    gold:    "#ffd583",   // Butter Cream — warm yellow accent
  },
  ...
  /* ---- POPUPS / EVENTS SHOWCASE (editable in Backend → Popups) ----- */
  popups: {
    enabled: true,
    eyebrow: "Out & About",
    title: "Our Popups",
    ...
    events: [
      // { title: "Lahore Eat Festival", location: "Gulberg, Lahore", date: "March 2026", image: "popup-1.jpg", caption: "Sold out in 3 hours." },
    ],
  },

  /* ---- DELIVERY / PICKUP DATES (Backend → Shop & Checkout) ---------
     Control which dates customers can choose at checkout.                */
  fulfilment: {
    earliest: "",          // YYYY-MM-DD — earliest date they can pick (e.g. after pre-orders close). Blank = tomorrow.
    blocked: [],           // YYYY-MM-DD dates to block out (closed days)
    note: "Pick a date after our current pre-order window closes.",
  },

  /* ---- PAYMENT / BANK TRANSFER (shown at checkout + confirmation) ---
     Edit all of this in Backend → Shop & Checkout → Payment.            */
  payment: {
    enabled: true,
  ...
  /* ---- ALLERGY NOTE (shown at checkout & on every product) ----------
     Edit this wording anytime. Keep it honest — it protects you and your
     customers.                                                           */
  allergy: {
    enabled: true,
    title: "Allergy information",
    text: "Second Scoop is not a nut-free, peanut-free, gluten-free, dairy-free or egg-free kitchen. Our scoops are made in a kitchen that also handles wheat, dairy, eggs, soya, peanuts and tree nuts, so all products may contain or come into contact with these allergens. If you have a severe allergy, please message us before ordering — your safety comes first.",
  },
  ...
  pages: {
    ...
    confirmation: {
      ...
      heading: "Thank you, {name}! 🍪",            // {name} = customer's first name
      message: "Your scoops are locked in. We'll confirm payment & timing shortly.",
  ...
  nav: {
    home: true, shop: true, bundles: true, vault: true, popups: true, preorders: true,
