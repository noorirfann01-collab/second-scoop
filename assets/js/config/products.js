...
window.SS_PRODUCTS = [
  ...
  /* ============================ HERO ============================== */
  {
    ...
    // Per-product add-ons — edit in Backend → Products → (this product) → Toppings.
    toppings: [
      { name: "Chocolate Drizzle",      prices: { pakistan: 100, toronto: 2 } },
      { name: "Salted Caramel Drizzle", prices: { pakistan: 120, toronto: 2 } },
