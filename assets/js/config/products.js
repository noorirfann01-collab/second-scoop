...
window.SS_CATEGORIES = [
  ...
  { id: "toppings",     name: "Toppings & Add-ons" },
...
window.SS_PRODUCTS = [
  ...
  /* =========================== TOPPINGS ========================== */
  /* Paid add-ons offered on the product page. topping:true keeps them
     out of the main shop grid — they only show as "add a topping".    */
  {
    id: "top-choc-drizzle", name: "Chocolate Drizzle", category: "toppings", topping: true,
    description: "A glossy pour of melted chocolate over your order.",
    images: [], hidden: false,
    regions: {
      pakistan: { status: "available", price: 100, inventory: 999, deliveryNotes: "" },
      toronto:  { status: "available", price: 2,   inventory: 999, deliveryNotes: "" },
    },
  },
  {
    id: "top-caramel-drizzle", name: "Salted Caramel Drizzle", category: "toppings", topping: true,
    description: "Warm salted caramel, poured on generously.",
    images: [], hidden: false,
    regions: {
      pakistan: { status: "available", price: 120, inventory: 999, deliveryNotes: "" },
      toronto:  { status: "available", price: 2,   inventory: 999, deliveryNotes: "" },
    },
  },
  {
    id: "top-signature-crunch", name: "Signature Crunch", category: "toppings", topping: true,
    description: "Our crunchy signature topping for extra texture.",
    images: [], hidden: false,
    regions: {
      pakistan: { status: "available", price: 150, inventory: 999, deliveryNotes: "" },
      toronto:  { status: "available", price: 3,   inventory: 999, deliveryNotes: "" },
    },
  },
  {
    id: "top-extra-cookie", name: "Extra Cookie", category: "toppings", topping: true,
    description: "Add a warm cookie on the side.",
    images: [], hidden: false,
    regions: {
      pakistan: { status: "available", price: 250, inventory: 999, deliveryNotes: "" },
      toronto:  { status: "available", price: 4,   inventory: 999, deliveryNotes: "" },
    },
  },
