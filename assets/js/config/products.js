/* Second Scoop — products.js
   Exported from the Backend on 11/06/2026, 00:19:15.
...
window.SS_PRODUCTS = [
  {
    ...
    "regions": {
      "pakistan": {
        ...
        "price": 1200,
        "inventory": 60,
        "deliveryNotes": "Best eaten warm — microwave 15s before serving."
      },
      "toronto": {
        "status": "available",
        "price": 14,
        "inventory": 40,
        "deliveryNotes": "Reheat 15s for the full gooey experience."
      }
    }
  },
  {
    ...
    "longDescription": "A proper bakery-style Chunkie — thick-cut, soft-centred and stacked with melting chocolate in every bite. Crisp at the edge, dense and chewy through the middle. Sold in a pack so you don't have to share (you can, but you won't want to).",
    "images": [
      "chunkies.jpg"
    ],
    "badge": "best-seller",
